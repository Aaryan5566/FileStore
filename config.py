...
APP_ID = int(os.environ.get("APP_ID", "23378704"))
...
#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://rohtashkumarsharma1994:NxNSQqdRkE8gHVHB@cluster0.5gatz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0i7hjvjb")
...
FORCE_SUB_CHANNEL1 = int(os.environ.get("FORCE_SUB_CHANNEL1", "-1002368088714"))
#put 0 to disable
